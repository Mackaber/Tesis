...
The reason MOA had better performance may be attributed to its characteristics to escape local minima. This was shown by doing the experiments in Section~\ref{sub:soa_implementation}, which had each objective function optimized individually, still MOA were able to outperform SOA.\\
