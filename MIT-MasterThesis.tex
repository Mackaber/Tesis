...
\documentclass[spanish,12pt,oneside,openright]{report}   	%% This sets the printing on just one side of a page
...
\insertChapter{Cp_Intro}
\insertChapter{Cp_Antecetendes}
\insertChapter{Cp_funciones_a_optimizar}
\insertChapter{Cp_Experimentos}
\insertChapter{Cp_Experimentos_II}
