...
\begin{enumerate}
    ...
    \item Define the relevant attributes and parameters to formulate the single and multi-objective functions.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{solution_model.png}
...
Chapter~\ref{chapter:chapter08} explains the conclusions of the research and mentions the future work that can be derived.