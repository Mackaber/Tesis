...
The results of this experiment can be seen in Table~\ref{table:results_interests_comp}. Here several comparisons of each pair of students are observed, using both CD and PC. With the difference between both, for comparison. This was done using the sets of interests specified in Table~\ref{table:sample_interests}, % in the same way it was specified in Chapter~\ref{chapter:chapter03}, 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{local_search.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{genetic_algorithm.png}
